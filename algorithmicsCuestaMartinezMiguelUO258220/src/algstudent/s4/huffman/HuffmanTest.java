...
public class HuffmanTest {
	...
	public void testCase1() {
		String file = "src/algstudent/s4/huffman/case1.txt";
	...
	public void testCase2() {
		String file = "src/algstudent/s4/huffman/case2.txt";
    	Huffman huffman = new Huffman(file);
    	huffman.run();
    	Map<String, String> codes = huffman.getCodes();
	...
	public void testCase3() {
		String file = "src/algstudent/s4/huffman/case3.txt";
    	Huffman huffman = new Huffman(file);
    	huffman.run();
    	Map<String, String> codes = huffman.getCodes();
	...
	public void testCase4() {
		String file = "src/algstudent/s4/huffman/case4.txt";
    	Huffman huffman = new Huffman(file);
    	huffman.run();
    	Map<String, String> codes = huffman.getCodes();
